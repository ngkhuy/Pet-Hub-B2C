...
import { HotelBookingCartItemType, SingleHotelBookingFormType } from "@/lib/types/booking";
			...
			<div className="rounded-2xl border bg-background/60 shadow-sm overflow-hidden">
				...
				<div className="border-t bg-muted/30 px-4 py-4">
					<div className="flex items-center justify-between">
						<p className="text-sm font-medium text-muted-foreground">Tổng thanh toán</p>
...
export function SingleHotelBookingDialog() {
	...
	async function onSubmit(data: SingleHotelBookingFormType) {
		try {
			...
			await bookingApi.createHotelSingleBooking(user!.id, bookingService!.id, submitData);
