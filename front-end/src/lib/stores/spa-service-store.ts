...
type SpaServiceStoreStates = {
  ...
  actions: SpaServiceStoreActions;
};

const store = create<SpaServiceStoreStates>()(
  //   devtools(
  (set) => ({
    services: [],
    filteredServices: [],
...
export const useSpaServiceStore = createSelectors(store);
